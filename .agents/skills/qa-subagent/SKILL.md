...
name: qa-subagent
description: >-
  Use this skill for QA planning, bug hunting, edge-case analysis, testing standards,
  and verifying implementations (e.g. writing Jest or Playwright test suites).
---
