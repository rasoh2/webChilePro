...
description: >-
  Use this skill to design, write, optimize, or review React and Vite frontend components.
  It guides the agent on modern hooks, Server Components, accessibility, performance, and best practices.
---
